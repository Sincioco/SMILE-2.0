...
try {
    ...
    foreach ($contract in @(
        ...
        'Graphics3D.CommitParticleBatch3D(SwordTrail, 0)',
        'Graphics3D.CommitParticleBatch3D(ShieldTrail, 0)',
