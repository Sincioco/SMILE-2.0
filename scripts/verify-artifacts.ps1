...
if ($versionInfo.FileVersion -ne '2.0.64.0' -or $versionInfo.ProductVersion -notlike '2.0.64*' -or
    $assemblyVersion -ne '2.0.64.0') {
...
Write-Host 'VSIX identity, assembly, file, and product versions are synchronized at 2.0.64.'
