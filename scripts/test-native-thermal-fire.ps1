...
try {
    ...
    & cmd.exe /d /c "call `"$taskSetup`" >nul && cl /nologo /EHsc /O2 examples\AdvancedFireVfxLab\ThermalDynamicsTests.cpp /Foartifacts\tests\ThermalDynamicsTests.obj /Feartifacts\tests\ThermalDynamicsTests.exe"
    ...
    & cmd.exe /d /c "call `"$taskSetup`" >nul && cl /nologo /MT /EHsc /O2 examples\AdvancedFireVfxLab\NativeFireGpuTests.cpp /Foartifacts\tests\NativeFireGpuTests.obj /Feartifacts\tests\NativeFireGpuTests.exe /link artifacts\runtime\Smile.NativeRuntime.lib $taskLibraries"
    ...
    & examples\AdvancedFireVfxLab\Build.ps1
    & artifacts\compiler\smilec.exe --project examples\AdvancedFireVfxLab\FireEmitterTests.smileproj `
    ...
    & node scripts\run-web-test.js artifacts\web\FireEmitterTests `
        --expected examples\AdvancedFireVfxLab\expected.txt --renderer3d --frames 20 --timeout 60000
