...
- `GLOW` hides or shows the current profile's equipment aura. Arin v5.6 enables it by default; profiles without the required weapon sockets leave the toggle unavailable.
