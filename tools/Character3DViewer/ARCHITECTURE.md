...
Substantial implementation still in `Program.smile` after the gizmo command-workflow
...
ceiling at 2,890 lines/73 procedures. Its next concrete reductions are the 292-line
inspector command dispatcher, 87-line Party pointer dispatcher and 237-line load
