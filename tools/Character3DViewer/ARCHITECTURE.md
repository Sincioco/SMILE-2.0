...
| `DrawInspectorOverlay` | 171 | Gathers explicit state-owner queries and preserves inspector, gizmo and Party overlay order. Raw leaves and four presentation groups have moved; the remaining composition boundary is pending. |
