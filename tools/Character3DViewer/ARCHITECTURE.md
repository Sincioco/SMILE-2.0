...
Substantial implementation still in `Program.smile` after the inspector keyboard/
camera-fit checkpoint is intentionally explicit: startup/retry/tab-switch orchestration;
...
ceiling at 3,101 lines/81 procedures. Its next concrete reductions are the 296-line
inspector command dispatcher, 217-line inspector-overlay composition and 237-line load
orchestration. `ViewerInspectorCommands` is 100 lines/2 procedures,
