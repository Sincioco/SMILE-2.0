...
Phase 6 adds optional stable `ApplicationId` project identity and the source-authored `Smile.RPG` 1.0.0 data/management package without adding syntax or RPG runtime helpers. See `phase6-rpg.md`.
