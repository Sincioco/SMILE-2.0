...
`Number` is integral. The distinct [Double type](double.md) provides checked binary64
arithmetic, explicit numeric conversions and fractional storage on native and Web.
