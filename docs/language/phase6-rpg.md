...
The [RPG Systems gallery](../../games/RPGSystems/README.md) Management option composes Smile.RPG with Smile.UI 2.0's reusable `Menu` and `MenuNavigator` Class facades across DirectX, GDI, and Web output. Quests, application character classes, skill trees, migrations, cloud saves, mouse, and touch remain deferred.
