...
The 24-bone rig has spine, neck, head, jaw, wing, leg, foot and tail chains. Five
original 30 Hz clips are Idle (4 s), Roar (3 s), FireBreath (4 s), ClawStrike (2.2 s)
and Hit (0.8 s). Idle loops; the other clips play once. Root, Chest, Head and Mouth
sockets follow their respective bones. The Mouth socket is attached to the jaw.
...
The viewer advances Arin, Orin, then Dragon. Dragon turns alternate a mouth-socket
fire sweep and a claw strike with an approach/return. Characters guard and play
