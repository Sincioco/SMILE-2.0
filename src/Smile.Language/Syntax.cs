...
public static class SyntaxFacts
{
    ...
    private static readonly Dictionary<string, SyntaxKind> Keywords = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["KEY_Z"] = SyntaxKind.KeyZKeyword,
        ["KEY_E"] = SyntaxKind.KeyEKeyword,
        ["KEY_PLUS"] = SyntaxKind.KeyPlusKeyword,
        ["KEY_MINUS"] = SyntaxKind.KeyMinusKeyword,
        ["KEY_C"] = SyntaxKind.KeyCKeyword,
        ["KEY_M"] = SyntaxKind.KeyMKeyword,
    ...
    public static long GetBuiltInConstantValue(SyntaxKind kind)
    {
        return kind switch
        {
            ...
            SyntaxKind.KeyZKeyword => 37,
            SyntaxKind.KeyEKeyword => 38,
            SyntaxKind.KeyPlusKeyword => 39,
            SyntaxKind.KeyMinusKeyword => 40,
            SyntaxKind.KeyCKeyword => 41,
            SyntaxKind.KeyMKeyword => 42,
