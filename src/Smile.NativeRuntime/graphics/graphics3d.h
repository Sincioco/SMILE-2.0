...
enum SmileRenderer3DCommand
{
    ...
    SMILE_3D_DISTORTION = 126,
    SMILE_3D_GPU_PARTICLE_SYSTEM = 127,
    SMILE_3D_SET_MODEL_NODE_ROTATION_OFFSET = 128,
    SMILE_3D_SET_OBJECT_PIVOT_ROTATION = 129,
    SMILE_3D_SET_OBJECT_CULL_MODE = 130,
    SMILE_3D_SET_BACKDROP_TEXTURE = 131,
    SMILE_3D_SET_OBJECT_NODE_OFFSETS = 132,
    SMILE_3D_CONFIGURE_REFLECTIONS = 133,
    SMILE_3D_SET_OBJECT_REFLECTION_MODE = 134,
    SMILE_3D_REFLECTION_VALUE = 135,
    SMILE_3D_SET_VIEWPORT = 136
};
