    ...
    private const string Runtime = """
        ...
        window.smile = (() => {
            ...
            return {
                ...
                print, clearScreen, wait, getKey, keyHeld, keyEventHeld, windowWidth, windowHeight, windowTitle, windowActivate, windowLoading, pointerX, pointerY, pointerDeltaX, pointerDeltaY,
