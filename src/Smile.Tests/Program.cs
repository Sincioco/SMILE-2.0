...
Run("VSIX templates render localized identity metadata within the aligned header", () =>
{
    ...
    var rendered = gameTemplate.Replace("$smileuser$", "Sin".PadRight(69), StringComparison.Ordinal)
        ...
        .Replace("$smileversion$", "2.0.51", StringComparison.Ordinal);
    ...
    Equal("' Programmed Date: " + "August 15, 2026".PadRight(69) + "SMILE: 2.0.51", header[4]);
    ...
    foreach (var manifest in new[] { gameManifest, consoleManifest })
    {
        ...
        Equal(true, manifest.Contains("Version=2.0.51.0", StringComparison.Ordinal));
    }
    ...
    Equal(true, project.Contains("<Version>2.0.51</Version>", StringComparison.Ordinal));
